 ...
 *
 * Return: it returns the allocated string which contains the history file
 */
...
/**
 * read_history - reads the stored history from file
 * @info: struct parameter
 *
 * Return: Returns the history count on successful execution,
...
/**
 * build_history_list - it appends an entry to the history of a linked list
 ...
 *
 * Return: A value of 0 is always returned
 */
